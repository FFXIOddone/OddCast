...
must include `oddcast.lua`, `weakness_data.lua`, and every generated
`weakness_data\<zone>.lua` file. Then run:
...
and are GPL-3.0-or-later. See the repository-root `THIRD_PARTY_NOTICES.md` and
